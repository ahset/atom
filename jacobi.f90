...
!
! Computa todos os autovalores e autovetores de uma matriz simetrica
! real A,
! que de tamanho NxN. No output, os elementos de A acima da diagonal sao
! desprezados.
! A matriz D retorna os autovalores de A em seus primeiros N elementos.
! V e uma matriz com 
! a mesma dimensao logica e fisica de A, na qual as colunas contem , no
! output, os autovetores normalizados de 
! A. 
...
!
      ...
      PARAMETER (NMAX=500)
      INTEGER i,ip,iq,j,k
      REAL*8 c,g,h,s,sm,p,t,tau,theta,tresh,b(NMAX),z(NMAX)
...
!     Este vetor ira acumular termos da forma tapq como na equacao da
!     Pag 458
...
! Ordenar os auovalores de Jacobi.(Ordem decrescente)
